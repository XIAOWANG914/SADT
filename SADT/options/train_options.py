...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--niter_decay', type=int, default=99, help='# of iter to linearly decay learning rate to zero')
        ...
        parser.add_argument('--penum_loss', type=float, default=0.5)
