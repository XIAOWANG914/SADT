...
class SRDDataset(BaseDataset):
    def initialize(self, opt):
        ...
        if 'train' in opt.phase:
            self.dir_A = os.path.join(opt.dataroot,'SRD', opt.phase + 'XSA')       
            self.dir_B = os.path.join(opt.dataroot,'SRD', opt.phase + 'V')
            self.dir_C = os.path.join(opt.dataroot,'SRD', opt.phase + 'JC')
            self.dir_FC = os.path.join(opt.dataroot,'SRD', opt.phase + 'JFC')
            self.dir_FL = os.path.join(opt.dataroot,'SRD', opt.phase + 'JFL')
            self.dir_GC = os.path.join(opt.dataroot,'SRD', opt.phase + 'JGC')
            self.dir_GL = os.path.join(opt.dataroot,'SRD', opt.phase + 'JGL')
        else:
            self.dir_A = os.path.join(opt.dataroot,'SRD', opt.phase + 'SA')        
            self.dir_B = os.path.join(opt.dataroot,'SRD', opt.phase + 'V')
            self.dir_C = os.path.join(opt.dataroot,'SRD', opt.phase + 'SC')
            self.dir_FC = os.path.join(opt.dataroot,'SRD', opt.phase + 'SFC')
            self.dir_FL = os.path.join(opt.dataroot,'SRD', opt.phase + 'SFL')
            self.dir_GC = os.path.join(opt.dataroot,'SRD', opt.phase + 'SGC')
            self.dir_GL = os.path.join(opt.dataroot,'SRD', opt.phase + 'SGL')
