...
class SwinModel(DistangleModel):
    def name(self):
    ...
    def initialize(self, opt):
        ...
        self.netR = networks.define_S('small')
        ...
        if self.isTrain:
            ...
            if opt.optimizer == 'adam':
                self.optimizer_R = torch.optim.AdamW(self.netR.parameters(),
    ...
    def forward(self):
        inputG = torch.cat([self.shadow_mask, self.shadow_L], 1)
        ...
        self.final = self.shadow_L * (1 + 2 * inputM)
